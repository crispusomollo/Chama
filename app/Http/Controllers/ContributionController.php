...
class ContributionController extends Controller
{
        ...
        )
    {
        ...
        */
        ...
        $expectedCollections =
            $totalMembers *
            RuleService::monthlyContribution();
    ...
    */
        ...
        )
    {
        ...
        $borrower = Borrower::findOrFail(
            $data['borrower_id']
        );

        $rule = RuleService::ruleForContributionDate(
        ...
        */
        ...
        //$monthlyContribution =
        //$rule->monthly_contribution;

        //$sharesAmount =
        //    $rule->shares_allocation;

        //$insuranceAmount =
        //    $rule->insurance_allocation;


        //$sharesAmount =
        //    SettingService::sharesAllocation();

        //$insuranceAmount =
        //    SettingService::insuranceAllocation();
        ...
        /*$sharesRatio =
            $sharesAmount / $monthlyContribution;

        $insuranceRatio =
            $insuranceAmount / $monthlyContribution;
        ...
        */
        ...
        $data['shares_amount'] = $rule->shares_allocation;
        $data['insurance_amount'] = $rule->insurance_allocation;
        ...
        $contribution = Contribution::create([
            ...
            'receipt_no' =>
                SettingService::generateReceiptNumber()
